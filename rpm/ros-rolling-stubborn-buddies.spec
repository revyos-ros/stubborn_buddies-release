...
Name:           ros-rolling-stubborn-buddies
Version:        1.0.0
Release:        6%{?dist}%{?release_suffix}
Summary:        ROS stubborn_buddies package
...
Requires:       ros-rolling-stubborn-buddies-msgs
...
BuildRequires:  ros-rolling-stubborn-buddies-msgs
...
%description
Demo that uses node composition of lifecycle nodes to achieve fail-over
robustness on ROS nodes
...
%changelog
* Wed Mar 06 2024 Marco A. Gutiérrez <marco@openrobotics.org> - 1.0.0-6
